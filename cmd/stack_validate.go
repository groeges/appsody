...
func newStackValidateCmd(rootConfig *RootCommandConfig) *cobra.Command {
	...
	stackValidateCmd.PersistentFlags().StringVar(&imageNamespace, "image-namespace", "dev.local", "namespace that the images will be created with (default is dev.local)")
